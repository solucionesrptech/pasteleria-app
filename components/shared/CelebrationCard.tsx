...
export const CelebrationCard: React.FC<CelebrationCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-[url('/images/background/fondoCard.png')] bg-cover bg-center bg-no-repeat px-4 py-6 text-center">
        <h3 className="font-decorative text-3xl lg:text-4xl font-normal text-stone-800 mb-2">
          {title}
        </h3>
